            ...
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-white border-0">
              <div className="rounded-t mb-0 px-6 py-6">
                ...
                <div className="btn-wrapper text-center">
                  ...
                  <button
                    className="border-2 bg-white  text-black font-normal px-12 py-2 rounded outline-none focus:outline-none mr-1 mb-1  inline-flex items-center text-xs ease-linear transition-all duration-150"
                    type="button"
                  >
                    <img
                      alt="..."
                  ...
                  <div>
                    <label className="inline-flex items-center cursor-pointer">
                      <input
                        id="customCheckLogin"
                        type="checkbox"
                        className="form-checkbox border-1 rounded text-black ml-1 w-5 h-5 ease-linear transition-all duration-150"
                      />
